...
export default function BookPage() {
  ...
  // production build (`next build`) doesn't fail prerendering `/books`.
  return (
    <Suspense
      fallback={
...
function BookPageInner() {
  ...
  // Deep links: /books?book=<id>[&page=<id>] — used by the global sidebar and
  // by the overview chapter index (which previously pointed at /books/<id>, a
  ...
  useEffect(() => {
    ...
    router.replace(`/books?book=${encodeURIComponent(requestedBookId)}`, {
      scroll: false,
    });
  }, [
    requestedPageId,
