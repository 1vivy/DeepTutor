...
export const selectActiveKey = (state: ChatStoreState): string | null => state.activeKey;

export const selectActiveSession = (state: ChatStoreState): ChatSession | null =>
...
export const selectSession = (key: string) => (state: ChatStoreState) => state.sessions[key] ?? null;
