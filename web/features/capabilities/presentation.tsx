...
export function mergeCapabilityPresentations(
  ...
  return capabilities
    ...
    .map((capability) => {
      ...
      if (known) return { ...known, allowedTools: [...known.allowedTools], defaultTools: [...known.defaultTools] };
      const label =
        typeof capability.manifest?.name === "string" && capability.manifest.name.trim()
